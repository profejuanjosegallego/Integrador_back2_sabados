...
public class EstudianteControlador {
    ...
    @PostMapping
    public ResponseEntity<?>activarPeticionGuardar(@RequestBody Estudiante estudiante){
        try{
            return ResponseEntity
                    .status(HttpStatus.OK)
                    .body(this.servicio.guardarEstudiante(estudiante));
    ...
    @GetMapping
    public ResponseEntity<?>activarBuscarTodos(){
        try {
            return ResponseEntity
                    .status(HttpStatus.OK)
